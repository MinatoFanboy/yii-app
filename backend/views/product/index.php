...
/* @var $searchModel common\models\searchs\ProductSearch */
...
<div class="product-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> Thêm sản phẩm', ['create'],
                    ['title'=> 'Thêm sản phẩm','class'=>'btn btn-primary']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Danh sách sản phẩm',
            ]
        ])?>
    </div>
</div>
