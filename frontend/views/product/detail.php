...
<section class="sec-product-detail bg0 p-t-155 p-b-60">
    <div class="container">
        <div class="row">
...
<section class="sec-relate-product bg0 p-t-45 p-b-105">
    <div class="container">
        ...
        <div class="wrap-slick2">
            <div class="slick2">
                <?php foreach ($product_relations as $product_relation): ?>
                    <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                        <!-- Block2 -->
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                <img src="<?= Yii::$app->urlManager->baseUrl . '/images/product/' . $product_relation->representation?>" alt="IMG-PRODUCT">
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="<?= Url::toRoute(['product/detail', 'path' => $product_relation->id.'_'.$product_relation->slug]) ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                        <?= $product_relation->name ?>
                                    </a>

                                    <span class="stext-105 cl3">
                                        <?= number_format($product_relation->price, 0, ',', '.').' VNĐ' ?>
                                    </span>
                                </div>
                            </div>
                        </div>
